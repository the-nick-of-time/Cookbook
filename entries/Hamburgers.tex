...
\begin{recipe}{Hamburgers}{4 servings}{20 minutes prep, 10 minutes cooking}
  ...
  When the burgers themselves are done, serve. You might want baked potatoes (\plainpageref{BakedPotato}), potato chips, corn (\plainpageref{Corn}), or green beans (\plainpageref{GreenBeans}) alongside.
\end{recipe}
