...
\begin{luacode}
texio.write_nl("Hello global world")
doc=doc or {}
...
doc.density = function(name, measure, dens, numerator, denominator)
	texio.write_nl("Hello density world")
	-- tex.print("=== DEBUG |" .. name .. "|" .. measure .. "|" .. numerator .. "|" .. denominator .. "|")
	local frac = nil
	local d = nil
	if denominator == "" then
		frac = numerator
...
% \def\type#2 %
% \def\numerator#3 %
% \directlua{tex.print(doc.density("\type flour", "cup", 150, "\numerator", "\denominator"))}%
% }
% \newcommand{\flour}[3]{\directlua{tex.print(doc.density("#1 flour", "cup", 150, "#2", "#3"))}}
\DeclareDocumentCommand{\flour}{ m m g }{%
\directlua{tex.print(doc.density(\luastring{#1} .. " flour", "cup", 150, "#2", \IfNoValueTF{#3}{""}{"#3"}))}%
}

\newcommand{\yeast}[2]{\directlua{tex.print(doc.density("yeast", "teaspoon", 3.4, "#1", "#2"))}}
